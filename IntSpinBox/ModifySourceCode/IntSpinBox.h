...
/**
 * A numerical entry box that allows for direct entry of the int number or allows the user to click and slide the number.
 */
UCLASS()
class HEROBATTLE_API UIntSpinBox : public UWidget
{
